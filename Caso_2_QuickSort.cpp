    ...
    */
    ...
    ¿Por qué ocurre esto?
        ...
        t(n+1) y el t(n), y luego viene la relacion entre el O(n+1) y el O(n).
         ...
         ____________________________________________________________________________________________________________________
       |            n          |         T(n)           |       n log(n)         |    T(n+1)/T(n)   |     O(n+1)/O(n)
       ---------------------------------------------------------------------------------------------------------------------
       |       7 000 	       |       1027000          |     26 915,68628      |    0,969814995    |     1,16009377
       ---------------------------------------------------------------------------------------------------------------------
       |       8 000  	       |       996000           |     31 224,71990      |    1,003012048    |     1,13974385
       ---------------------------------------------------------------------------------------------------------------------
       |       9 000  	       |       999000           |     35 588,18258      |    1,997997998    |     1,12396861 
       ---------------------------------------------------------------------------------------------------------------------
       |       10 000  	       |      1996000           |     40 000,00000      |    0,997995992    |     1,11138299
       ---------------------------------------------------------------------------------------------------------------------
       |       11 000  	       |      1992000           |     44 455,31954      |    1,001506024    |     1,10110951
       ---------------------------------------------------------------------------------------------------------------------
       |       12 000  	       |      1995000           |     48 950,17495      |    1,000501253    |     1,09256532
       ---------------------------------------------------------------------------------------------------------------------
       |       13 000 	       |      1996000           |     53 481,26358      |    0,998496994    |     1,08534819
       ---------------------------------------------------------------------------------------------------------------------
       |       14 000  	       |      1993000           |     58 045,79250      |    1,001505268    |     1,07917157
       ---------------------------------------------------------------------------------------------------------------------
       |       15 000  	       |      1996000           |     62 641,36889      |    1,497995992    |     1,07382583
       ---------------------------------------------------------------------------------------------------------------------
       |       16 000  	       |      2990000           |     67 265,91972      |    1,000668896    |     1,06915407
       ---------------------------------------------------------------------------------------------------------------------
       |       17 000  	       |      2992000           |     71 917,63166      |    1,000668449    |     1,06503653
       ---------------------------------------------------------------------------------------------------------------------
       |       18 000  	       |      2994000           |     76 594,90509      |    0,998997996    |     1,06138024
       ---------------------------------------------------------------------------------------------------------------------
       |       19 000  	       |      2991000           |     81 296,31842      |       ...         |         ...
       ---------------------------------------------------------------------------------------------------------------------
